...
export const Share = () => {
    ...
    const {data,isLoading,error,isError,isSuccess} = useShareBrain(shareObj.shareId)
    ...
    return <div className=" bg-gray-100">
        <div className="md:max-w-7xl max-w-xs mx-auto py-5">
            ...
            {isLoading && <div className="flex  h-screen w-full justify-center items-center">
                <Loader />
            </div>}
            {isError && <div className="flex  h-screen w-full justify-center items-center ">
